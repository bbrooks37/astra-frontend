...
import { Plane, PlusCircle, Navigation, Calendar, PenTool, BookOpen, Search, History } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="bg-light min-vh-100 w-100 m-0 p-0 overflow-x-hidden animate-in">
      ...
      <div className="container-fluid p-4">
        ...
        {/* Flight Log Form */}
        {showForm && (
          <div className="card shadow-lg mb-4 border-0 p-4 bg-white animate-in">
              ...
              <table className="table table-hover align-middle mb-0">
                ...
                <tbody>
                  {filteredMaintenance.map(item => {
                    ...
                    return (
                      <tr key={item.id}>
                        <td className="px-4 fw-bold text-primary">{item.task_number}</td>
                        <td>
